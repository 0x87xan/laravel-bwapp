...
This version of application created for demonstration of mistakes in queries to xml recourses that can lead to xpath injection
...
1) Clone branch xpath with the following command

```console
$ git clone -b xpath https://github.com/0x87xan/laravel-bwapp.git
```
...
10) Test this web application version for XPath vulnerabilities.
