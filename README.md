...
This version of application created for demonstration of mistakes in users data parsing that can lead to path traversal
...
1) Clone branch path_traversal with the following command

```console
$ git clone -b path_traversal https://github.com/0x87xan/laravel-bwapp.git
```
...
10) Test this web application version for path traversal vulnerabilities.
