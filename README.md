...
This version of application created for demonstration of mistakes in configuration that can lead to password brute force 
...
1) Clone branch pass-brute-force with the following command

```console
$ git clone -b pass-brute-force https://github.com/0x87xan/laravel-bwapp.git
```
